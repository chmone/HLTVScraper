...
def get_parsed_page(url, delay=0.5):
    ...
    element = driver.find_element(By.XPATH, '//*[@id="CybotCookiebotDialogBodyLevelButtonLevelOptinAllowAll"]').click()
    #driver.accept_alert()
    #time.sleep(10)
    ...
    return BeautifulSoup(html_source).text, "lxml"
...
if __name__ == "__main__":
    ...
    # print(top30teams())
    # print(top_players())
    # print(get_players(5378))
    # print(get_team_info(5378))
    # print(get_matches())
    # print(get_results())
    # print(get_results_by_date("2022-01-01", "2022-01-31"))
    # print(get_match_countdown(2345678))
    # print(MATCH_WITH_COUNTDOWN)